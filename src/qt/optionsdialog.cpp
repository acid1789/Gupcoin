    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GPC-light"), QVariant("light"));
    ui->theme->addItem(QString("GPC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GPC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GPC-traditional"), QVariant("trad"));
