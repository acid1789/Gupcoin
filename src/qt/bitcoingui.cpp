    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gupcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gupcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gupcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gupcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gupcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gupcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gupcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gupcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a gupcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gupcoin Core help message to get a list with possible Gupcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gupcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gupcoin network", "", count));
}
...
{
    QString strTitle = tr("Gupcoin Core"); // default title
