...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517517123, 8488, 0x1e0ffff0, 1, 50 * COIN);
  
        consensus.hashGenesisBlock = genesis.GetHash();
	

        assert(consensus.hashGenesisBlock == uint256S("0x0000067cdf4b93975643284d1d4dce6fb710898c38ecada9bd3b04f204336c4f"));
	...
	vSeeds.push_back(CDNSSeedData("45.76.228.32", "45.76.228.32"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (   0, uint256S("0x0000067cdf4b93975643284d1d4dce6fb710898c38ecada9bd3b04f204336c4f"))
