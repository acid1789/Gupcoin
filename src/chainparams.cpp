...
{
    const char* pszTimestamp = "Natalie Wood's mysterious death back in the headlines";
...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData) {
            ...
            (   0, uint256S("0x0000009e9b5da6248b72f379cc67fc78fd909ac8bef18209fa6005859b03e920"))
