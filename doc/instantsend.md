...
This mechanism has been integrated into Bitcore-Node-Gupcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gupcoincoin/insight-api-gupcoin#web-socket-api](https://github.com/gupcoincoin/insight-api-gupcoin#web-socket-api) 
* API: [https://github.com/gupcoincoin/insight-api-gupcoin#instantsend-transactions](https://github.com/gupcoincoin/insight-api-gupcoin#instantsend-transactions) 
...
By default, the Gupcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gupcoin Core daemon:
